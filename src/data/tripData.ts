...
export const HOME_BASE: Location = {
  ...
  lng: 101.7279,
  category: 'home-base',
  description: 'Your home base in Cheras. Modern condo with pool, playground, and 40+ amenities. 500m covered walkway to Maluri MRT/LRT station.',
  city: 'Cheras',
...
export const LOCATIONS: Location[] = [
  ...
  // NEARBY MALLS (Plan B favorites - walking distance)
  {
    ...
    lng: 101.7214,
    category: 'shopping',
    description: 'Large modern mall with kids play areas, excellent food court, and air conditioning. Perfect rainy day backup.',
    city: 'Cheras',
  ...
  // KLCC AREA
  {
    ...
    description: 'Beautiful park with wading pool for kids, playground, and jogging paths. Iconic view of Petronas Towers.',
    city: 'Kuala Lumpur',
  ...
  },
  {
    ...
    lng: 101.7116,
    category: 'attraction',
    description: 'Iconic twin towers with sky bridge and observation deck. Educational for kids about architecture.',
    city: 'Kuala Lumpur',
  ...
  },
  {
    ...
    lng: 101.7115,
    category: 'toddler-friendly',
    description: 'Malaysia\'s largest aquarium with 90m underwater tunnel. 5,000+ sea creatures. Touch pools for kids.',
    city: 'Kuala Lumpur',
  ...
  },
  {
    ...
    lng: 101.7118,
    category: 'shopping',
    description: 'Premier shopping mall at the base of Petronas Towers. Petrosains science center for kids inside.',
    city: 'Kuala Lumpur',
  ...
  // BATU CAVES
  {
    ...
    lng: 101.6840,
    category: 'temple',
    description: 'Iconic Hindu temple complex with 272 rainbow steps and giant Lord Murugan statue. Cultural must-see.',
    city: 'Gombak',
    ...
    dressCode: 'Cover shoulders and knees. Long pants or skirt required. Sarong rental available (RM3).',
  ...
  // GENTING HIGHLANDS
  {
    ...
    lng: 101.7932,
    category: 'shopping',
    description: 'Hilltop mega mall at 6,000 feet. Indoor theme park, shopping, dining. Cool weather escape!',
  ...
  },
  {
    ...
    lng: 101.7932,
    category: 'playground',
    description: 'Indoor theme park with 20+ rides. Has toddler-friendly rides like bumper cars and mini train.',
    city: 'Genting Highlands',
  ...
  },
  {
    ...
    lng: 101.6968,
    category: 'shopping',
    description: 'Bustling Chinatown market. Bargain shopping, street food, and cultural experience.',
    city: 'Kuala Lumpur',
  ...
  },
  {
    ...
    lng: 101.7132,
    category: 'shopping',
    description: 'Upscale shopping mall in Bukit Bintang. Great for air-conditioned break and luxury shopping.',
    city: 'Bukit Bintang',
  ...
  // NATURE & PARKS
  {
    ...
    lng: 101.6879,
    category: 'toddler-friendly',
    description: 'World\'s largest free-flight aviary. Hornbills, flamingos, peacocks. Toddlers love the bird feeding!',
    city: 'Kuala Lumpur',
  ...
  },
  {
    ...
    lng: 101.6879,
    category: 'nature',
    description: 'Beautiful green space in the city. Orchid garden, deer park, and open spaces for toddler to run.',
    city: 'Kuala Lumpur',
  ...
  },
  {
    ...
    lng: 101.7050,
    category: 'toddler-friendly',
    description: 'Beautiful lakeside park with playground and stunning KL skyline views. Great for sunset.',
    city: 'Kuala Lumpur',
  ...
  // PUTRAJAYA
  {
    ...
    lng: 101.6833,
    category: 'attraction',
    description: 'Scenic boat cruise on Malaysia\'s administrative capital. Beautiful bridges and government buildings.',
    city: 'Putrajaya',
  ...
  // MUSEUMS
  {
    ...
    drivingTime: '15-25 min',
    warnings: [
      'Not very interactive for toddlers',
      'Better for parents than 19-month-old'
    ],
    tips: [
  ...
  // CAMERON HIGHLANDS
  {
    ...
    lng: 101.3762,
    category: 'nature',
    description: 'Cool highland escape. Tea plantations, strawberry farms, and fresh air. 3-night stay planned.',
...
export const DAILY_PLANS: DayPlan[] = [
  {
    ...
    planA: [
      { id: 'd1-1', locationId: 'home-base', startTime: '15:00', endTime: '16:00', notes: 'Check in, rest after flight' },
      { id: 'd1-2', locationId: 'aeon-maluri', startTime: '16:30', endTime: '18:30', notes: 'Grocery shopping' },
      { id: 'd1-3', locationId: 'klcc-park', startTime: '19:00', endTime: '21:00', notes: 'Evening stroll, fountain show' }
    ],
    planB: [
      { id: 'd1-b1', locationId: 'home-base', startTime: '15:00', endTime: '18:00', notes: 'Rest, let toddler adjust' },
      { id: 'd1-b2', locationId: 'sunway-velocity', startTime: '18:30', endTime: '21:00', notes: 'Mall dinner, easy walking' }
    ],
    notes: [
  ...
  },
  {
    ...
    planA: [
      { id: 'd2-1', locationId: 'batu-caves', startTime: '07:00', endTime: '10:00', notes: 'Early start! Beat the heat and crowds' },
      { id: 'd2-2', locationId: 'home-base', startTime: '10:30', endTime: '11:30', isNapTime: true, notes: 'Toddler morning nap' },
      { id: 'd2-3', locationId: 'zoo-view', startTime: '14:00', endTime: '16:00', notes: 'Nature trails' },
      { id: 'd2-4', locationId: 'home-base', startTime: '16:30', endTime: '17:00', isNapTime: true, notes: 'Quick afternoon nap' }
    ],
    planB: [
      { id: 'd2-b1', locationId: 'sunway-velocity', startTime: '10:00', endTime: '12:00', notes: 'Mall morning if too tired from yesterday' },
      { id: 'd2-b2', locationId: 'home-base', startTime: '12:30', endTime: '14:00', isNapTime: true, notes: 'Extended nap' },
      { id: 'd2-b3', locationId: 'aeon-maluri', startTime: '15:00', endTime: '18:00', notes: 'Light shopping' }
    ],
    notes: [
  ...
  },
  {
    ...
    planA: [
      { id: 'd3-1', locationId: 'genting-skyavenue', startTime: '09:00', endTime: '15:00', notes: 'Full Genting experience' },
      { id: 'd3-2', locationId: 'home-base', startTime: '16:00', endTime: '17:00', isNapTime: true, notes: 'Rest after long day' },
      { id: 'd3-3', locationId: 'suria-klcc', startTime: '18:00', endTime: '21:00', notes: 'Evening mall stroll' }
    ],
    planB: [
      { id: 'd3-b1', locationId: 'sunway-pyramid', startTime: '10:00', endTime: '14:00', notes: 'Indoor playground at Play ParQ' },
      { id: 'd3-b2', locationId: 'home-base', startTime: '14:30', endTime: '16:00', isNapTime: true, notes: 'Afternoon nap' },
      { id: 'd3-b3', locationId: 'pavilion-kl', startTime: '17:00', endTime: '20:00', notes: 'Evening shopping' }
    ],
    notes: [
  ...
  },
  {
    ...
    planA: [
      { id: 'd4-1', locationId: 'suria-klcc', startTime: '10:00', endTime: '12:00', notes: 'Morning shopping' },
      { id: 'd4-2', locationId: 'home-base', startTime: '12:30', endTime: '14:00', isNapTime: true, notes: 'Nap time' },
      { id: 'd4-3', locationId: 'petaling-street', startTime: '15:00', endTime: '17:00', notes: 'Chinatown exploration' },
      { id: 'd4-4', locationId: 'jalan-alor', startTime: '18:30', endTime: '21:00', notes: 'Christmas Eve dinner' }
    ],
    planB: [
      { id: 'd4-b1', locationId: 'pavilion-kl', startTime: '10:00', endTime: '13:00', notes: 'Christmas decorations are amazing!' },
      { id: 'd4-b2', locationId: 'home-base', startTime: '14:00', endTime: '16:00', isNapTime: true, notes: 'Extended rest' },
      { id: 'd4-b3', locationId: 'sunway-velocity', startTime: '17:00', endTime: '20:00', notes: 'Local Christmas dinner' }
    ],
    notes: [
  ...
  },
  {
    ...
    planA: [
      { id: 'd5-1', locationId: 'home-base', startTime: '07:00', endTime: '12:00', notes: 'Christmas morning at home, pool time' },
      { id: 'd5-2', locationId: 'aquaria-klcc', startTime: '14:30', endTime: '17:00', notes: 'Aquarium visit' },
      { id: 'd5-3', locationId: 'klcc-park', startTime: '17:30', endTime: '20:00', notes: 'Evening park time, fountain show' }
    ],
    planB: [
      { id: 'd5-b1', locationId: 'home-base', startTime: '07:00', endTime: '14:00', notes: 'Full rest day at condo' },
      { id: 'd5-b2', locationId: 'sunway-velocity', startTime: '15:00', endTime: '18:00', notes: 'Light mall visit' }
    ],
    notes: [
      'Christmas Day - relax!',
  ...
  },
  {
    ...
    planA: [
      { id: 'd6-1', locationId: 'cameron-highlands', startTime: '08:00', endTime: '18:00', notes: '3-night stay at Brinchang Farm' }
    ],
    planB: [],
    notes: [
  ...
  },
  {
    ...
    planA: [
      { id: 'd10-1', locationId: 'home-base', startTime: '16:00', endTime: '18:30', notes: 'Rest after long drive' },
      { id: 'd10-2', locationId: 'jalan-alor', startTime: '19:30', endTime: '22:00', notes: 'Dinner at Bukit Bintang' }
    ],
    planB: [
      { id: 'd10-b1', locationId: 'home-base', startTime: '16:00', endTime: '20:00', notes: 'Full rest evening' },
      { id: 'd10-b2', locationId: 'sunway-velocity', startTime: '20:00', endTime: '21:30', notes: 'Quick dinner nearby' }
    ],
    notes: [
  ...
  },
  {
    ...
    title: 'Self-Care Day',
    planA: [
      { id: 'd11-1', locationId: 'suria-klcc', startTime: '10:30', endTime: '15:00', notes: 'Massage, nails, hair' },
      { id: 'd11-2', locationId: 'pavilion-kl', startTime: '16:30', endTime: '22:00', notes: 'Shopping' }
    ],
    planB: [
      { id: 'd11-b1', locationId: 'sunway-velocity', startTime: '10:00', endTime: '14:00', notes: 'Spa services available here too' },
      { id: 'd11-b2', locationId: 'home-base', startTime: '14:30', endTime: '17:00', notes: 'Rest' },
      { id: 'd11-b3', locationId: 'aeon-maluri', startTime: '18:00', endTime: '20:00', notes: 'Light shopping' }
    ],
    notes: [
  ...
  },
  {
    ...
    planA: [
      { id: 'd12-1', locationId: 'home-base', startTime: '07:00', endTime: '15:00', notes: 'Relax day before big night' },
      { id: 'd12-2', locationId: 'klcc-park', startTime: '20:00', endTime: '00:30', notes: 'NYE countdown, fireworks!' }
    ],
    planB: [
      { id: 'd12-b1', locationId: 'home-base', startTime: '07:00', endTime: '22:00', notes: 'Watch fireworks from home' },
      { id: 'd12-b2', locationId: 'sunway-velocity', startTime: '18:00', endTime: '21:00', notes: 'NYE dinner at mall' }
    ],
    notes: [
      'NEW YEAR\'S EVE!',
  ...
  },
  {
    ...
    planA: [
      { id: 'd13-1', locationId: 'home-base', startTime: '07:00', endTime: '14:00', notes: 'Sleep in, pool time' },
      { id: 'd13-2', locationId: 'suria-klcc', startTime: '15:00', endTime: '20:00', notes: 'Light celebration' }
    ],
    planB: [
      { id: 'd13-b1', locationId: 'home-base', startTime: '07:00', endTime: '18:00', notes: 'Full rest day' },
      { id: 'd13-b2', locationId: 'sunway-velocity', startTime: '18:30', endTime: '21:00', notes: 'Dinner' }
    ],
    notes: [
      'Recovery from NYE',
  ...
  },
  {
    ...
    planA: [
      { id: 'd14-1', locationId: 'kl-bird-park', startTime: '09:00', endTime: '12:00', notes: 'Bird feeding at 10:30am!' },
      { id: 'd14-2', locationId: 'perdana-gardens', startTime: '12:30', endTime: '14:00', notes: 'Picnic lunch' },
      { id: 'd14-3', locationId: 'home-base', startTime: '14:30', endTime: '16:00', isNapTime: true, notes: 'Nap' },
      { id: 'd14-4', locationId: 'titiwangsa-gardens', startTime: '17:00', endTime: '19:00', notes: 'Sunset at lake' }
    ],
    planB: [
      { id: 'd14-b1', locationId: 'aquaria-klcc', startTime: '10:00', endTime: '13:00', notes: 'Revisit if missed earlier' },
      { id: 'd14-b2', locationId: 'suria-klcc', startTime: '14:00', endTime: '17:00', notes: 'Mall time' },
      { id: 'd14-b3', locationId: 'home-base', startTime: '17:30', endTime: '20:00', notes: 'Rest' }
    ],
    notes: [
  ...
  },
  {
    ...
    planA: [
      { id: 'd15-1', locationId: 'putrajaya-lake', startTime: '08:00', endTime: '14:00', notes: 'Cruise + Gardens' },
      { id: 'd15-2', locationId: 'home-base', startTime: '15:00', endTime: '17:00', isNapTime: true, notes: 'Rest' },
      { id: 'd15-3', locationId: 'sunway-velocity', startTime: '18:00', endTime: '21:00', notes: 'Dinner' }
    ],
    planB: [
      { id: 'd15-b1', locationId: 'sunway-pyramid', startTime: '10:00', endTime: '15:00', notes: 'Indoor playground instead' },
      { id: 'd15-b2', locationId: 'home-base', startTime: '16:00', endTime: '20:00', notes: 'Pool and rest' }
    ],
    notes: [
  ...
  },
  {
    ...
    planA: [
      { id: 'd16-1', locationId: 'sunway-pyramid', startTime: '10:00', endTime: '18:00', notes: 'Play ParQ, ice rink viewing, shopping' }
    ],
    planB: [
      { id: 'd16-b1', locationId: 'home-base', startTime: '08:00', endTime: '14:00', notes: 'Pool and rest' },
      { id: 'd16-b2', locationId: 'sunway-velocity', startTime: '15:00', endTime: '19:00', notes: 'Local mall instead' }
    ],
    notes: [
  ...
  },
  {
    ...
    planA: [
      { id: 'd17-1', locationId: 'pavilion-kl', startTime: '10:00', endTime: '15:00', notes: 'Final shopping' },
      { id: 'd17-2', locationId: 'home-base', startTime: '16:00', endTime: '20:00', notes: 'Packing' },
      { id: 'd17-3', locationId: 'jalan-alor', startTime: '21:00', endTime: '23:00', notes: 'Last dinner out' }
    ],
    planB: [
      { id: 'd17-b1', locationId: 'sunway-velocity', startTime: '10:00', endTime: '14:00', notes: 'Nearby shopping' },
      { id: 'd17-b2', locationId: 'home-base', startTime: '15:00', endTime: '22:00', notes: 'Packing + dinner at home' }
    ],
    notes: [
      'Last full day!',
  ...
  },
  {
    ...
    title: 'Departure Day',
    planA: [
      { id: 'd18-1', locationId: 'home-base', startTime: '07:00', endTime: '09:00', notes: 'Final packing, checkout' }
    ],
    planB: [],
    notes: [
      'Flight at 12:00pm',
...
export const TRAVEL_PLANS: TravelPlan[] = [
  { id: 'plan-a', name: 'Plan A - Main Itinerary', color: '#10B981', description: 'Your planned activities', isDefault: true },
  { id: 'plan-b', name: 'Plan B - Rainy/Tired Day', color: '#3B82F6', description: 'Indoor alternatives when weather is bad or toddler needs rest', isDefault: false },
  { id: 'toddler', name: 'Toddler Favorites', color: '#F472B6', description: 'Best rated for 19-month-old', isDefault: false },
  { id: 'shopping', name: 'Shopping', color: '#8B5CF6', description: 'Malls and markets', isDefault: false },
  { id: 'cultural', name: 'Cultural', color: '#F59E0B', description: 'Temples, museums, heritage', isDefault: false },
  { id: 'nature', name: 'Nature & Parks', color: '#22C55E', description: 'Outdoor green spaces', isDefault: false },
  { id: 'food', name: 'Food & Dining', color: '#EF4444', description: 'Restaurants and food streets', isDefault: false },
  { id: 'day-trip', name: 'Day Trips', color: '#06B6D4', description: 'Longer excursions outside KL', isDefault: false },
  { id: 'medical', name: 'Medical', color: '#DC2626', description: 'Hospitals and clinics', isDefault: false }
];
    ...
    warnings: [
      {
        ...
        level: 2,
        description: 'Exercise Increased Caution due to kidnapping risk. You are NOT visiting this area.'
      }
    ]
  },
  healthTips: [
...
export const WEATHER_INFO = {
  summary: 'December-January is ideal for West Coast Malaysia (KL, Cameron Highlands). Avoid East Coast due to monsoon.',
  klWeather: {
