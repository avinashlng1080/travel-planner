...
export function FloatingHeader({
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 h-14 bg-slate-900/80 backdrop-blur-xl border-b border-slate-700/50">
      <div className="h-full flex items-center justify-between px-4">
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-white hidden sm:block">TripPlanner</span>
          </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="flex items-center gap-2 px-3 py-1.5 text-slate-400 hover:text-white hover:bg-slate-700/50 rounded-lg transition-colors">
