    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex flex-col items-center flex-shrink-0 w-14">
          ...
          <span className="text-[10px] text-slate-400">to {item.endTime}</span>
        </div>
        ...
        <div className="flex-1 min-w-0">
          ...
          {location && !item.isNapTime && (
            <div className="mt-2 space-y-1">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] text-slate-500">toddler-friendly</span>
              </div>
          ...
          {/* Notes */}
          {item.notes && (
            <div className="mt-2 flex items-start gap-1.5 text-[11px] text-slate-600 bg-cyan-50 rounded-lg p-2">
