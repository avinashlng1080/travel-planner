...
const statusStorageAtom = atomWithStorage<OnboardingStatus>('travel-planner-onboarding-status', 'pending');
const stepsCompletedStorageAtom = atomWithStorage<OnboardingStep[]>('travel-planner-onboarding-stepsCompleted', []);
...
// Action atoms
export const startOnboardingAtom = atom(
  null,
  (_get, set) => {
...
export const skipOnboardingAtom = atom(
  null,
  (_get, set) => {
...
export const advanceToNextStepAtom = atom(
  null,
  (get, set) => {
...
export const goToStepAtom = atom(
  null,
  (_get, set, step: OnboardingStep) => {
    set(currentStepAtom, step);
  }
);

export const completeCurrentStepAtom = atom(
  null,
  (get, set) => {
    const currentStep = get(currentStepAtom);
    const stepsCompleted = get(stepsCompletedAtom);
...
export const awardStampAtom = atom(
  null,
  (get, set, step: OnboardingStep) => {
    const stamps = get(stampsAtom);
...
export const markInteractionAtom = atom(
  null,
  (get, set, type: 'marker' | 'chat' | 'plan') => {
    const currentStep = get(currentStepAtom);
